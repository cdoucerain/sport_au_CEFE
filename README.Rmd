...
- [`R/`](https://github.com/cdoucerain/projet/tree/main/R):
...
Launch the [`make.R`](https://github.com/cdoucerain/projet/tree/main/make.R)
file with:
...
check out our [Contributor Guidelines](https://github.com/cdoucerain/projet/blob/main/CONTRIBUTING.md).
